...
// 2. Acces specific values in array using indexes
...
// 2. Hoe many elements starting from that index should be deleted
...
// 3. Printing objext variable use the JSON.stringify method
...
let keyProp = "age";
console.group(`person[keyProp] = ${person[keyProp]}`);
console.group(`person[keyProp] = ${person.keyProp}`);
